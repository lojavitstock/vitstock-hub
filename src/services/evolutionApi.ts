...
export class EvolutionApiService {
   ...
   */
  static async sendTextMessage(instanceName: string, number: string, text: string, remoteJid?: string, clientMessageId?: string, quotedMessage?: QuotedMessage, replyTraceId?: string) {
    if (USE_MOCK) {
